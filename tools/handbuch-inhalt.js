...
kasten('Wenn „Übersetzen" im Menü fehlt', 'Im installierten App-Fenster bietet Chrome das Übersetzen oft nicht an. Dann „In Chrome öffnen" tippen: Derselbe Übersetzer öffnet sich im Chrome-Browser mit denselben Dokumenten, und das Ergebnis liegt danach auch in der App. Öffnet sich Chrome nicht, liegt die Adresse schon in der Zwischenablage: Chrome öffnen, oben in die Adresszeile einfügen.', '#1f4e8c', '#ffffff');
