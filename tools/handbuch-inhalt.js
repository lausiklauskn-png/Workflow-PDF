...
kasten('Wenn „Übersetzen" im Menü fehlt', 'Im installierten App-Fenster bietet Chrome das Übersetzen oft nicht an. Dann „In Chrome öffnen" tippen: Die App kopiert die Adresse. Chrome starten, oben in die Adresszeile einfügen: derselbe Übersetzer öffnet sich mit denselben Dokumenten, und das Ergebnis liegt danach auch in der App.', '#1f4e8c', '#ffffff');
