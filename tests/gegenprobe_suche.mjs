...
const FAELLE = [
  ...
  { name: 'Markierung klebt am Öffnen ohne Suche', datei: 'assets/app.js', anker: '    S.funde = fundMarken(fund);', ersatz: '    if (fund) S.funde = fundMarken(fund);',
    // zwei Riegel decken einander (Öffnen UND Schließen leeren) — beide weg, sonst misst der Fall nichts
    extra: { datei: 'assets/app.js', anker: 'S.doc = null; S.sel = null; S.funde = [];', ersatz: 'S.doc = null; S.sel = null;' }, trifft: /ohne Suche geöffnet/ },
