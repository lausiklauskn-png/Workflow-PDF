...
const dateien = ['assets/app.js', 'assets/db.js', 'assets/erkennung.js', 'assets/export.js', 'assets/html-export.js', 'assets/uebersetzung.js', 'sw.js', 'tests/uebersetzung.mjs', 'tests/e2e.mjs'];
let rot = 0;
