...
const CACHE_VERSION = 'workfloh-pdf-v18';
const SCHALE = [
  './', './index.html', './impressum.html', './manifest.webmanifest',
  './assets/style.css?v=8', './assets/db.js?v=2', './assets/erkennung.js?v=4', './assets/blatt.js?v=1', './assets/export.js?v=7', './assets/html-export.js?v=1', './assets/uebersetzung.js?v=5', './assets/app.js?v=18',
