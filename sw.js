...
const CACHE_VERSION = 'workfloh-pdf-v13';
const SCHALE = [
  './', './index.html', './impressum.html', './manifest.webmanifest',
  './assets/style.css?v=7', './assets/db.js?v=2', './assets/erkennung.js?v=4', './assets/export.js?v=5', './assets/html-export.js?v=1', './assets/uebersetzung.js?v=1', './assets/app.js?v=13',
