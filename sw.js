...
const CACHE_VERSION = 'workfloh-pdf-v35';
const SCHALE = [
  './', './index.html', './impressum.html', './manifest.webmanifest',
  './assets/style.css?v=14', './assets/db.js?v=3', './assets/suche.js?v=2', './assets/zip.js?v=1', './assets/erkennung.js?v=5', './assets/blatt.js?v=1', './assets/export.js?v=7', './assets/html-export.js?v=2', './assets/uebersetzung.js?v=11', './assets/sprache-texte.js?v=7', './assets/sprache.js?v=1', './assets/app.js?v=33',
