...
const CACHE_VERSION = 'workfloh-pdf-v12';
const SCHALE = [
  './', './index.html', './impressum.html', './manifest.webmanifest',
  './assets/style.css?v=6', './assets/db.js?v=2', './assets/erkennung.js?v=4', './assets/export.js?v=5', './assets/html-export.js?v=1', './assets/app.js?v=12',
