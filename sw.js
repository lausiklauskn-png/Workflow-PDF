...
const CACHE_VERSION = 'workfloh-pdf-v31';
const SCHALE = [
  './', './index.html', './impressum.html', './manifest.webmanifest',
  './assets/style.css?v=11', './assets/db.js?v=2', './assets/erkennung.js?v=5', './assets/blatt.js?v=1', './assets/export.js?v=7', './assets/html-export.js?v=2', './assets/uebersetzung.js?v=10', './assets/sprache-texte.js?v=3', './assets/sprache.js?v=1', './assets/app.js?v=29',
